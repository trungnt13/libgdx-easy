...
public class StyleAtlas extends Skin
{
	...
	json.setSerializer(Skin.class, new ReadOnlySerializer<Skin>()
		...
		private void readNamedObjects (Json json, Class type,
			ObjectMap<String, ObjectMap> valueMap)
		{
			...
			try {
			    ...
			    throw new SerializationException("Error reading "
				    + type.getSimpleName() + ": " + valueEntry.key, ex);
			}
		    }
		}
	    });
	...
	json.setSerializer(BitmapFont.class, new ReadOnlySerializer<BitmapFont>()
		...
		public BitmapFont read (Json json, Object jsonData, Class type)
		{
			...
			throw new SerializationException("Error loading bitmap font: " + fontFile,
				ex);
		    }
		}
	    });
	...
	json.setSerializer(ScalingSet.class, new ReadOnlySerializer<ScalingSet>()
		...
		public ScalingSet read (Json json, Object jsonData, Class type)
		{
		    ...
		    return new ScalingSet().set(layoutx, layouty, layoutwidth, layoutheight,
			    whratio, hwratio);
		}
	    });
