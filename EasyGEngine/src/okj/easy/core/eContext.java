...
public class eContext
{
	...
	/**
	 * Remove all data which contain in the context from manager , even if that
	 * data hadn't been loaded(not recommended)
	 * 
	 * @param context
	 *            your context
	 */
	...
	/**
	 * Directly unload the given data from the manager(carefull when you call
	 * this method)
	 * 
	 * @param data
	 *            unLoaded data
