...
public class eGraphics {
	...
	public static TextureRegion[] split (TextureRegion region, int totalRegionNumber, int numberOfRegionInARow,
		...
		for (int i = 0; i < numberOfRegionInAColumn; i++) {
			for (int j = 0; j < numberOfRegionInARow; j++) {
				tmp[count] = new TextureRegion(texture, firstX + (j * (tileWidth + padding)), firstY
