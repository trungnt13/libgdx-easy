...
public final class E {
	...
	public static final class resolutions {
		...
		/**
		 * This mode keep the UI width = 500 and height = 800 (in portrait) and (800,500) for landscape
		 */
		public static final byte FIXED_RESOLUTION_MODE = 1;
		/**
		 * This mode keep the UI height = 800 but still keep the screen ratio by multi UI height with (witdh/height ratio)
		 */
		public static final byte FIXED_MULTI_RESOLUTION_MODE = 2;
		/**
		 * Whatever happen the UI width and height wont change only the orientaion change
		 */
