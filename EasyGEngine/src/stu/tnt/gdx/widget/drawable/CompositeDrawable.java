...
/**
 * CompositeDrawable.java Drawable contain two region, one upper, one downer and
 * dont support rotation or scale Created on: Feb 3, 2013 Author: Trung
 */
public class CompositeDrawable extends BaseDrawable {
	...
	/**
	 * Creates an unitialized TextureRegionDrawable. The texture region must be
	 * set before use.
	 */
