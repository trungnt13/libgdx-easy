...
public final class Timer
{
    ...
    /**
     * Schedules a task to occur once after the specified delay and then repeatedly at the specified
    ...
    /**
     * Schedules a task to occur once after the specified delay and then a number of additional
	...
	/**
	 * Cancels the task. It will not be executed until it is scheduled again. This method can be
	 * called at any time.
	 */
	public void cancel ()
	{
	...
	public void run ()
	{
		...
		eAdmin.egame.schedule(t, t.delaySeconds, t.intervalSeconds, tmp);
	    }
	}
