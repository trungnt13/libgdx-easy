...
public class KeyframedModelViewer implements ApplicationListener {
	...
	public static void main(String[] argv){
		new LwjglApplication(new KeyframedModelViewer("data/invader/data/knight.md2", "data/invader/data/knight.jpg"), "", 480, 320, false);
	}
...
//		cam.position.add(-delta*5,0, 0);
//		cam.rotate(Vector3.Y, -delta*2);
//		cam.rotate(Vector3.X, -delta*2);
		cam.update();
		cam.apply(Gdx.gl10);
