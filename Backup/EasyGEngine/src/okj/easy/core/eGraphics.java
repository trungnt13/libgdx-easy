...
public class eGraphics
{
    ...
    public static TextureRegion[] split (Texture texture, int regionNumber, int tileWidth,
	    int tileHeight, int padding)
    {
    ...
    public static TextureRegion[] split (TextureRegion region, int totalRegionNumber,
	    int numberOfRegionInARow,
	...
	for (int i = 0; i < numberOfRegionInAColumn; i++) {
		...
		tmp[count] = new TextureRegion(texture, firstX + (j * (tileWidth + padding)),
			firstY
