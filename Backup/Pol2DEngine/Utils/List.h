 ...
 *
 */
static const unsigned long NaN = 4294967295U;
...
namespace BasicDataStructures {
	...
	class List {
		...
		public:
			...
			/**
			 * Returns the index of the specified item or NaN if not found
			 * @param input The element to check for
			 * @return The index or position of @em input in the list.
			 * If input is not in the list NaN is returned.
			 */
	...
	template<class list_type>
	inline void List<list_type>::replace (list_type input, list_type filler,
