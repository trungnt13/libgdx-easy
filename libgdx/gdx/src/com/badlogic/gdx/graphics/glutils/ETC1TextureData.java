...
public class ETC1TextureData implements TextureData {
	...
	public void consumeCompressedData () {
		...
		if (!Gdx.graphics.supportsExtension("GL_OES_compressed_ETC1_RGB8_texture") || Gdx.graphics.isGL20Available() == false) {			Pixmap pixmap = ETC1.decodeImage(data, Format.RGB565);
